...
public class LoginGUI extends JFrame implements MouseListener {
    ...
    public JPanel pnHeader() {
        ...
        lb_exit.addMouseListener(new MouseListener() {
            ...
            public void mouseEntered(MouseEvent e) {
                lb_exit.setBackground(Color.decode("#013A63"));            
            }
    ...
    public JPanel pnCenter() {
        ...
        lb_text_login.setForeground(Color.decode("#2A6F97"));
        ...
        this.tf_user.setBorder(BorderFactory.createLineBorder(Color.decode("#61A5C2"), 2));
        this.tf_password.setBorder(BorderFactory.createLineBorder(Color.decode("#61A5C2"), 2));
        ...
        lb_username.setForeground(Color.decode("#61A5C2"));
        ...
        lb_password.setForeground(Color.decode("#61A5C2"));
    ...
    public JPanel pnSouth() {
        ...
        this.btn_login.setBackground(Color.decode("#2A6F97"));
