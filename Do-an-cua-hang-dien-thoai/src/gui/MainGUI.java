...
public class MainGUI extends JFrame implements MouseListener {
    ...
    public JPanel createHeader() {
        ...
        pn_header.setBackground(Color.decode("#013A63"));
        ...
        lb_exit.addMouseListener(new MouseListener() {
            ...
            public void mouseEntered(MouseEvent e) {
                lb_exit.setBackground(Color.decode("#2A6F97"));            
            }
    ...
    public JPanel createNav() {
        ...
        pn_nav.setBackground(Color.decode("#013A63"));
        
        // add avatar
        JLabel lb_ava = new JLabel();
        lb_ava.setPreferredSize(new Dimension(200, 100));
        lb_ava.setOpaque(true);
        lb_ava.setBackground(Color.decode("#2A6F97"));
        IconModel icon = new IconModel(200, 100, "logo.png");
